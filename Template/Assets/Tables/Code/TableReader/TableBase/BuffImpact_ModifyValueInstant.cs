...
namespace Tables
{
    public partial class BuffImpact_ModifyValueInstantRecord  : TableRecordBase
    {
        ...
        public BuffImpact_ModifyValueInstantRecord(DataRecord dataRecord)
        {
            if (dataRecord != null)
            {
                ValueStr = dataRecord;
    ...
    public partial class BuffImpact_ModifyValueInstant : TableFileBase
    {
        public Dictionary<string, BuffImpact_ModifyValueInstantRecord> Records { get; internal set; }
        ...
        public BuffImpact_ModifyValueInstantRecord GetRecord(string id)
        {
            try
            {
                return Records[id];
            ...
            {
                throw new Exception("BuffImpact_ModifyValueInstant" + ": " + id, ex);
            }
        }

        public BuffImpact_ModifyValueInstant(string pathOrContent,bool isPath = true)
        {
            Records = new Dictionary<string, BuffImpact_ModifyValueInstantRecord>();
            if(isPath)
            {
        ...
        private void ParserTableStr(string content)
        {
            ...
            using (var reader = new CsvReader(rdr))
            {
                ...
                while (reader.HasMoreRecords)
                {
                    ...
                    BuffImpact_ModifyValueInstantRecord record = new BuffImpact_ModifyValueInstantRecord(data);
